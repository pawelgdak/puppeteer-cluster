...
export default class Cluster<JobData = any, ReturnData = any> extends EventEmitter {
    ...
    private queueJob;
    queue(data: JobData, taskFunction?: TaskFunction<JobData, ReturnData>, unshift?: Boolean): Promise<void>;
    queue(taskFunction: TaskFunction<JobData, ReturnData>, unshift?: Boolean): Promise<void>;
